...
const style = {
    ...
    carWrap: 'relative flex h-[300px] w-[200px] cursor-pointer flex-col rounded-lg bg-slate-600 shadow-lg transition-all duration-300 hover:shadow-2xl hover:bg-rose-500',
    button: 'relative text-lg bg bg-slate-400 p-0 px-2 border border-white rounded-md hover:bg-blue-500 cursor-pointer',
    redbut: 'relative text-lg bg bg-slate-400 p-0 px-2 border border-white rounded-md hover:bg-red-500 cursor-pointer',
    ...
    blue: 'text-black hover:text-red-500 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300'
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.contentWrapper}>
                ...
                <button className={style.button} onClick={handleClick}> Sort Name</button>
                <button className={style.redbut} onClick={handleClick}> Sort Performance</button>
                <button className={style.button} onClick={handleClick}> Sort Date</button>
